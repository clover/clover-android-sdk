...
public class ResetMessage extends com.clover.sdk.v3.remotemessage.Message {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<ResetMessage> {
    method {
      @Override
      public Object extractValue(ResetMessage instance) {
  ...
  private GenericClient<ResetMessage> genClient;
  ...
  */
  public ResetMessage() {
    super(false);
    genClient = new GenericClient<ResetMessage>(this);
    this.setMethod(com.clover.sdk.v3.remotemessage.Method.RESET);
  }
  ...
  * Constructs a new empty instance.
  */
  protected ResetMessage(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public ResetMessage(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public ResetMessage(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public ResetMessage(ResetMessage src) {
    this();
   ...
   */
  public ResetMessage copyChanges() {
    ResetMessage copy = new ResetMessage();
   ...
   */
  public void mergeChanges(ResetMessage src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new ResetMessage(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<ResetMessage> CREATOR = new android.os.Parcelable.Creator<ResetMessage>() {
    @Override
    public ResetMessage createFromParcel(android.os.Parcel in) {
      ResetMessage instance = new ResetMessage(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public ResetMessage[] newArray(int size) {
      return new ResetMessage[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<ResetMessage> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<ResetMessage>() {
    @Override
    public ResetMessage create(org.json.JSONObject jsonObject) {
      return new ResetMessage(jsonObject);
    }
  };
