...
public class RetrievePaymentRequestMessage extends com.clover.sdk.v3.remotemessage.Message {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<RetrievePaymentRequestMessage> {
    externalPaymentId {
      @Override
      public Object extractValue(RetrievePaymentRequestMessage instance) {
  ...
  private GenericClient<RetrievePaymentRequestMessage> genClient;

  /**
  * Constructs a new empty instance.
  */
  public RetrievePaymentRequestMessage() {
    super(false);
    genClient = new GenericClient<RetrievePaymentRequestMessage>(this);
    this.setMethod(com.clover.sdk.v3.remotemessage.Method.RETRIEVE_PAYMENT_REQUEST);
  }
  ...
  * Constructs a new empty instance.
  */
  protected RetrievePaymentRequestMessage(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public RetrievePaymentRequestMessage(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public RetrievePaymentRequestMessage(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public RetrievePaymentRequestMessage(RetrievePaymentRequestMessage src) {
    this();
   ...
   */
  public RetrievePaymentRequestMessage setExternalPaymentId(java.lang.String externalPaymentId) {
   ...
   */
  public RetrievePaymentRequestMessage copyChanges() {
    RetrievePaymentRequestMessage copy = new RetrievePaymentRequestMessage();
   ...
   */
  public void mergeChanges(RetrievePaymentRequestMessage src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new RetrievePaymentRequestMessage(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<RetrievePaymentRequestMessage> CREATOR = new android.os.Parcelable.Creator<RetrievePaymentRequestMessage>() {
    @Override
    public RetrievePaymentRequestMessage createFromParcel(android.os.Parcel in) {
      RetrievePaymentRequestMessage instance = new RetrievePaymentRequestMessage(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public RetrievePaymentRequestMessage[] newArray(int size) {
      return new RetrievePaymentRequestMessage[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<RetrievePaymentRequestMessage> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<RetrievePaymentRequestMessage>() {
    @Override
    public RetrievePaymentRequestMessage create(org.json.JSONObject jsonObject) {
      return new RetrievePaymentRequestMessage(jsonObject);
    }
  };
