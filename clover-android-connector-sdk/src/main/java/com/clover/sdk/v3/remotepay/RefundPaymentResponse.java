...
public class RefundPaymentResponse extends com.clover.sdk.v3.remotepay.BaseResponse {
  ...
  private final GenericClient<RefundPaymentResponse> genClient;
  ...
  public RefundPaymentResponse() {
    super(false);
    genClient = new GenericClient<RefundPaymentResponse>(this);
  }
   ...
   * Constructs a new empty instance.
   */
  protected RefundPaymentResponse(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public RefundPaymentResponse(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public RefundPaymentResponse(RefundPaymentResponse src) {
    this();
   ...
   */
  public RefundPaymentResponse copyChanges() {
    RefundPaymentResponse copy = new RefundPaymentResponse();
   ...
   */
  public void mergeChanges(RefundPaymentResponse src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new RefundPaymentResponse(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<RefundPaymentResponse> CREATOR = new android.os.Parcelable.Creator<RefundPaymentResponse>() {
    @Override
    public RefundPaymentResponse createFromParcel(android.os.Parcel in) {
      RefundPaymentResponse instance = new RefundPaymentResponse(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public RefundPaymentResponse[] newArray(int size) {
      return new RefundPaymentResponse[size];
    }
  };
