 ...
 * <li>{@link #getAuthenticationToken authenticationToken}</li>
 * </ul>
 */
@SuppressWarnings("all")
public class PairingRequestMessage extends com.clover.sdk.v3.remotemessage.Message {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<PairingRequestMessage> {
    name {
      @Override
      public Object extractValue(PairingRequestMessage instance) {
  ...
  private GenericClient<PairingRequestMessage> genClient;
  ...
  */
  public PairingRequestMessage() {
    super(false);
    genClient = new GenericClient<PairingRequestMessage>(this);
    this.setMethod(com.clover.sdk.v3.remotemessage.Method.PAIRING_REQUEST);
  }
  ...
  * Constructs a new empty instance.
  */
  protected PairingRequestMessage(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public PairingRequestMessage(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public PairingRequestMessage(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public PairingRequestMessage(PairingRequestMessage src) {
    this();
   ...
   */
  public PairingRequestMessage copyChanges() {
    PairingRequestMessage copy = new PairingRequestMessage();
   ...
   */
  public void mergeChanges(PairingRequestMessage src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new PairingRequestMessage(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<PairingRequestMessage> CREATOR = new android.os.Parcelable.Creator<PairingRequestMessage>() {
    @Override
    public PairingRequestMessage createFromParcel(android.os.Parcel in) {
      PairingRequestMessage instance = new PairingRequestMessage(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public PairingRequestMessage[] newArray(int size) {
      return new PairingRequestMessage[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<PairingRequestMessage> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<PairingRequestMessage>() {
    @Override
    public PairingRequestMessage create(org.json.JSONObject jsonObject) {
      return new PairingRequestMessage(jsonObject);
    }
  };
