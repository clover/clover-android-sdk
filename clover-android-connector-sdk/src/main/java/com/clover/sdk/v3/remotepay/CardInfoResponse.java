...
public class CardInfoResponse extends com.clover.sdk.v3.remotepay.BaseResponse {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<CardInfoResponse> {
    card {
      @Override
      public Object extractValue(CardInfoResponse instance) {
  ...
  private GenericClient<CardInfoResponse> genClient;
