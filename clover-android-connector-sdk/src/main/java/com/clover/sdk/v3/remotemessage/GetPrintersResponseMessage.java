...
public class GetPrintersResponseMessage extends com.clover.sdk.v3.remotemessage.Message {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<GetPrintersResponseMessage> {
    printers {
      @Override
      public Object extractValue(GetPrintersResponseMessage instance) {
  ...
  private GenericClient<GetPrintersResponseMessage> genClient;

  /**
  * Constructs a new empty instance.
  */
  public GetPrintersResponseMessage() {
    super(false);
    genClient = new GenericClient<GetPrintersResponseMessage>(this);
    this.setMethod(com.clover.sdk.v3.remotemessage.Method.GET_PRINTERS_RESPONSE);
  }
  ...
  * Constructs a new empty instance.
  */
  protected GetPrintersResponseMessage(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public GetPrintersResponseMessage(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public GetPrintersResponseMessage(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public GetPrintersResponseMessage(GetPrintersResponseMessage src) {
    this();
   ...
   */
  public GetPrintersResponseMessage setPrinters(java.util.List<com.clover.sdk.v3.printer.Printer> printers) {
   ...
   */
  public GetPrintersResponseMessage copyChanges() {
    GetPrintersResponseMessage copy = new GetPrintersResponseMessage();
   ...
   */
  public void mergeChanges(GetPrintersResponseMessage src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new GetPrintersResponseMessage(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<GetPrintersResponseMessage> CREATOR = new android.os.Parcelable.Creator<GetPrintersResponseMessage>() {
    @Override
    public GetPrintersResponseMessage createFromParcel(android.os.Parcel in) {
      GetPrintersResponseMessage instance = new GetPrintersResponseMessage(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public GetPrintersResponseMessage[] newArray(int size) {
      return new GetPrintersResponseMessage[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<GetPrintersResponseMessage> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<GetPrintersResponseMessage>() {
    @Override
    public GetPrintersResponseMessage create(org.json.JSONObject jsonObject) {
      return new GetPrintersResponseMessage(jsonObject);
    }
  };
