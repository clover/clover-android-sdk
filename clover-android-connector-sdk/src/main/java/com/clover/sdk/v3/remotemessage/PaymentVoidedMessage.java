...
public class PaymentVoidedMessage extends com.clover.sdk.v3.remotemessage.Message {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<PaymentVoidedMessage> {
    payment {
      @Override
      public Object extractValue(PaymentVoidedMessage instance) {
  ...
  private GenericClient<PaymentVoidedMessage> genClient;

  /**
  * Constructs a new empty instance.
  */
  public PaymentVoidedMessage() {
    super(false);
    genClient = new GenericClient<PaymentVoidedMessage>(this);
    this.setMethod(com.clover.sdk.v3.remotemessage.Method.PAYMENT_VOIDED);
  }
  ...
  * Constructs a new empty instance.
  */
  protected PaymentVoidedMessage(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public PaymentVoidedMessage(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public PaymentVoidedMessage(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public PaymentVoidedMessage(PaymentVoidedMessage src) {
    this();
   ...
   */
  public PaymentVoidedMessage setPayment(com.clover.sdk.v3.payments.Payment payment) {
   ...
   */
  public PaymentVoidedMessage setVoidReason(com.clover.sdk.v3.order.VoidReason voidReason) {
   ...
   */
  public PaymentVoidedMessage copyChanges() {
    PaymentVoidedMessage copy = new PaymentVoidedMessage();
   ...
   */
  public void mergeChanges(PaymentVoidedMessage src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new PaymentVoidedMessage(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<PaymentVoidedMessage> CREATOR = new android.os.Parcelable.Creator<PaymentVoidedMessage>() {
    @Override
    public PaymentVoidedMessage createFromParcel(android.os.Parcel in) {
      PaymentVoidedMessage instance = new PaymentVoidedMessage(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public PaymentVoidedMessage[] newArray(int size) {
      return new PaymentVoidedMessage[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<PaymentVoidedMessage> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<PaymentVoidedMessage>() {
    @Override
    public PaymentVoidedMessage create(org.json.JSONObject jsonObject) {
      return new PaymentVoidedMessage(jsonObject);
    }
  };
