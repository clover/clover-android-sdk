...
public class CloseoutResponse extends com.clover.sdk.v3.remotepay.BaseResponse {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<CloseoutResponse> {
    batch {
      @Override
      public Object extractValue(CloseoutResponse instance) {
  ...
  private GenericClient<CloseoutResponse> genClient;
