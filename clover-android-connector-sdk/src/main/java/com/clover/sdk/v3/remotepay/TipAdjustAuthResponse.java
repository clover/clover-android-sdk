...
public class TipAdjustAuthResponse extends com.clover.sdk.v3.remotepay.BaseResponse {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<TipAdjustAuthResponse> {
    tipAmount {
      @Override
      public Object extractValue(TipAdjustAuthResponse instance) {
  ...
  private GenericClient<TipAdjustAuthResponse> genClient;

  /**
  * Constructs a new empty instance.
  */
  public TipAdjustAuthResponse() {
    super(false);
    genClient = new GenericClient<TipAdjustAuthResponse>(this);
  }
  ...
  * Constructs a new empty instance.
  */
  protected TipAdjustAuthResponse(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public TipAdjustAuthResponse(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public TipAdjustAuthResponse(TipAdjustAuthResponse src) {
    this();
   ...
   */
  public TipAdjustAuthResponse setTipAmount(java.lang.Long tipAmount) {
   ...
   */
  public TipAdjustAuthResponse setPaymentId(java.lang.String paymentId) {
   ...
   */
  public TipAdjustAuthResponse copyChanges() {
    TipAdjustAuthResponse copy = new TipAdjustAuthResponse();
   ...
   */
  public void mergeChanges(TipAdjustAuthResponse src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new TipAdjustAuthResponse(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<TipAdjustAuthResponse> CREATOR = new android.os.Parcelable.Creator<TipAdjustAuthResponse>() {
    @Override
    public TipAdjustAuthResponse createFromParcel(android.os.Parcel in) {
      TipAdjustAuthResponse instance = new TipAdjustAuthResponse(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public TipAdjustAuthResponse[] newArray(int size) {
      return new TipAdjustAuthResponse[size];
    }
  };
