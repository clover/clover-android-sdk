...
public class VerifySignatureMessage extends com.clover.sdk.v3.remotemessage.Message {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<VerifySignatureMessage> {
    payment {
      @Override
      public Object extractValue(VerifySignatureMessage instance) {
  ...
  private GenericClient<VerifySignatureMessage> genClient;
  ...
  */
  public VerifySignatureMessage() {
    super(false);
    genClient = new GenericClient<VerifySignatureMessage>(this);
    this.setMethod(com.clover.sdk.v3.remotemessage.Method.VERIFY_SIGNATURE);
  }
  ...
  * Constructs a new empty instance.
  */
  protected VerifySignatureMessage(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public VerifySignatureMessage(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public VerifySignatureMessage(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public VerifySignatureMessage(VerifySignatureMessage src) {
    this();
   ...
   */
  public VerifySignatureMessage setPayment(com.clover.sdk.v3.payments.Payment payment) {
   ...
   * The parameter is not copied so changes to it will be reflected in this instance and vice-versa.
   */
  public VerifySignatureMessage setSignature(com.clover.sdk.v3.base.Signature signature) {
   ...
   */
  public VerifySignatureMessage copyChanges() {
    VerifySignatureMessage copy = new VerifySignatureMessage();
   ...
   */
  public void mergeChanges(VerifySignatureMessage src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new VerifySignatureMessage(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<VerifySignatureMessage> CREATOR = new android.os.Parcelable.Creator<VerifySignatureMessage>() {
    @Override
    public VerifySignatureMessage createFromParcel(android.os.Parcel in) {
      VerifySignatureMessage instance = new VerifySignatureMessage(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public VerifySignatureMessage[] newArray(int size) {
      return new VerifySignatureMessage[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<VerifySignatureMessage> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<VerifySignatureMessage>() {
    @Override
    public VerifySignatureMessage create(org.json.JSONObject jsonObject) {
      return new VerifySignatureMessage(jsonObject);
    }
  };
