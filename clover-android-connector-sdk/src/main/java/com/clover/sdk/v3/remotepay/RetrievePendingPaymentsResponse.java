...
public class RetrievePendingPaymentsResponse extends com.clover.sdk.v3.remotepay.BaseResponse {
    ...
    private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<RetrievePendingPaymentsResponse> {
        pendingPaymentEntries {
            @Override
            public Object extractValue(RetrievePendingPaymentsResponse instance) {
    ...
    private GenericClient<RetrievePendingPaymentsResponse> genClient;

    /**
     * Constructs a new empty instance.
     */
    public RetrievePendingPaymentsResponse() {
        super(false);
        genClient = new GenericClient<RetrievePendingPaymentsResponse>(this);
    }
     ...
     * Constructs a new empty instance.
     */
    protected RetrievePendingPaymentsResponse(boolean noInit) {
        super(false);
        genClient = null;
    }
     ...
     */
    public RetrievePendingPaymentsResponse(org.json.JSONObject jsonObject) {
        this();
     ...
     */
    public RetrievePendingPaymentsResponse(RetrievePendingPaymentsResponse src) {
        this();
     ...
     */
    public RetrievePendingPaymentsResponse setPendingPaymentEntries(java.util.List<com.clover.sdk.v3.base.PendingPaymentEntry> pendingPaymentEntries) {
     ...
     */
    public RetrievePendingPaymentsResponse copyChanges() {
        RetrievePendingPaymentsResponse copy = new RetrievePendingPaymentsResponse();
     ...
     */
    public void mergeChanges(RetrievePendingPaymentsResponse src) {
        if (src.genClient.getChangeLog() != null) {
            genClient.mergeChanges(new RetrievePendingPaymentsResponse(src).getJSONObject(), src.genClient);
        }
    }

    public static final android.os.Parcelable.Creator<RetrievePendingPaymentsResponse> CREATOR = new android.os.Parcelable.Creator<RetrievePendingPaymentsResponse>() {
        @Override
        public RetrievePendingPaymentsResponse createFromParcel(android.os.Parcel in) {
            RetrievePendingPaymentsResponse instance = new RetrievePendingPaymentsResponse(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
        ...
        @Override
        public RetrievePendingPaymentsResponse[] newArray(int size) {
            return new RetrievePendingPaymentsResponse[size];
        }
    };
