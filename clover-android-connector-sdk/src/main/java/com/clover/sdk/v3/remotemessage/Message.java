...
public class Message extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<Message> {
    method {
      @Override
      public Object extractValue(Message instance) {
  ...
  private GenericClient<Message> genClient;

  /**
  * Constructs a new empty instance.
  */
  public Message() {
    genClient = new GenericClient<Message>(this);
  }
  ...
  */
   ...
   */
  public Message(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public Message(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public void mergeChanges(Message src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new Message(src).getJSONObject(), src.genClient);
    }
  }
  ...
  public static final android.os.Parcelable.Creator<Message> CREATOR = new android.os.Parcelable.Creator<Message>() {
    ...
    public Message createFromParcel(android.os.Parcel in) {
      Message instance = new Message(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
  ...
  public static final com.clover.sdk.JSONifiable.Creator<Message> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<Message>() {
    @Override
    public Message create(org.json.JSONObject jsonObject) {
