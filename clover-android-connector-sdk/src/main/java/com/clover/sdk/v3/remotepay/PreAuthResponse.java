...
public class PreAuthResponse extends com.clover.sdk.v3.remotepay.PaymentResponse {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<PreAuthResponse> {
    payment {
      @Override
      public Object extractValue(PreAuthResponse instance) {
  ...
  private GenericClient<PreAuthResponse> genClient;
