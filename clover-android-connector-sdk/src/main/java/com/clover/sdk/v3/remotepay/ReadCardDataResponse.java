...
public class ReadCardDataResponse extends com.clover.sdk.v3.remotepay.BaseResponse {
  ...
  private enum CacheKey implements com.clover.sdk.ExtractionStrategyEnum {
    cardData
        (com.clover.sdk.extractors.RecordExtractionStrategy.instance(com.clover.sdk.v3.base.CardData.JSON_CREATOR)),
    success
  ...
  private final GenericClient<ReadCardDataResponse> genClient;
  ...
  public ReadCardDataResponse() {
    super(false);
    genClient = new GenericClient<ReadCardDataResponse>(this);
  }
   ...
   * Constructs a new empty instance.
   */
  protected ReadCardDataResponse(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public ReadCardDataResponse(String json) throws IllegalArgumentException {
    this();
   ...
   */
  public ReadCardDataResponse(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public ReadCardDataResponse(ReadCardDataResponse src) {
    this();
   ...
   */
  public ReadCardDataResponse setCardData(com.clover.sdk.v3.base.CardData cardData) {
  ...
  public ReadCardDataResponse copyChanges() {
    ReadCardDataResponse copy = new ReadCardDataResponse();
   ...
   */
  public void mergeChanges(ReadCardDataResponse src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new ReadCardDataResponse(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<ReadCardDataResponse> CREATOR = new android.os.Parcelable.Creator<ReadCardDataResponse>() {
    @Override
    public ReadCardDataResponse createFromParcel(android.os.Parcel in) {
      ReadCardDataResponse instance = new ReadCardDataResponse(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public ReadCardDataResponse[] newArray(int size) {
      return new ReadCardDataResponse[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<ReadCardDataResponse> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<ReadCardDataResponse>() {
    public Class<ReadCardDataResponse> getCreatedClass() {
      return ReadCardDataResponse.class;
    }

    @Override
    public ReadCardDataResponse create(org.json.JSONObject jsonObject) {
