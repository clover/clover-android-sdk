...
public class PaymentRejectedMessage extends com.clover.sdk.v3.remotemessage.Message {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<PaymentRejectedMessage> {
    payment {
      @Override
      public Object extractValue(PaymentRejectedMessage instance) {
  ...
  */
  public PaymentRejectedMessage() {
    super(false);
    genClient = new GenericClient<PaymentRejectedMessage>(this);
    this.setMethod(com.clover.sdk.v3.remotemessage.Method.PAYMENT_REJECTED);
  }
  ...
  * Constructs a new empty instance.
  */
  protected PaymentRejectedMessage(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public PaymentRejectedMessage(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public PaymentRejectedMessage(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public PaymentRejectedMessage(PaymentRejectedMessage src) {
    this();
   ...
   */
  public PaymentRejectedMessage setPayment(com.clover.sdk.v3.payments.Payment payment) {
   ...
   */
  public PaymentRejectedMessage setVoidReason(com.clover.sdk.v3.order.VoidReason voidReason) {
  ...
  public PaymentRejectedMessage copyChanges() {
    PaymentRejectedMessage copy = new PaymentRejectedMessage();
   ...
   */
  public void mergeChanges(PaymentRejectedMessage src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new PaymentRejectedMessage(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<PaymentRejectedMessage> CREATOR = new android.os.Parcelable.Creator<PaymentRejectedMessage>() {
    @Override
    public PaymentRejectedMessage createFromParcel(android.os.Parcel in) {
      PaymentRejectedMessage instance = new PaymentRejectedMessage(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public PaymentRejectedMessage[] newArray(int size) {
      return new PaymentRejectedMessage[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<PaymentRejectedMessage> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<PaymentRejectedMessage>() {
    @Override
    public PaymentRejectedMessage create(org.json.JSONObject jsonObject) {
