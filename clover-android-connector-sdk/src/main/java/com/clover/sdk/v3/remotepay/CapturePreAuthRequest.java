...
public class CapturePreAuthRequest extends com.clover.sdk.v3.remotepay.BaseRequest {
   ...
   */
  public CapturePreAuthRequest(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public CapturePreAuthRequest(CapturePreAuthRequest src) {
    this();
   ...
   */
  public CapturePreAuthRequest setAmount(java.lang.Long amount) {
   ...
   */
  public CapturePreAuthRequest setTipAmount(java.lang.Long tipAmount) {
   ...
   */
  public CapturePreAuthRequest setPaymentId(java.lang.String paymentId) {
   ...
   */
  public CapturePreAuthRequest copyChanges() {
    CapturePreAuthRequest copy = new CapturePreAuthRequest();
   ...
   */
  public void mergeChanges(CapturePreAuthRequest src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new CapturePreAuthRequest(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<CapturePreAuthRequest> CREATOR = new android.os.Parcelable.Creator<CapturePreAuthRequest>() {
    @Override
    public CapturePreAuthRequest createFromParcel(android.os.Parcel in) {
      CapturePreAuthRequest instance = new CapturePreAuthRequest(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public CapturePreAuthRequest[] newArray(int size) {
      return new CapturePreAuthRequest[size];
    }
  };
