...
public class SaleResponse extends com.clover.sdk.v3.remotepay.PaymentResponse {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<SaleResponse> {
    payment {
      @Override
      public Object extractValue(SaleResponse instance) {
  ...
  private GenericClient<SaleResponse> genClient;
  ...
  */
  public SaleResponse() {
    super(false);
    genClient = new GenericClient<SaleResponse>(this);
  }
  ...
  * Constructs a new empty instance.
  */
  protected SaleResponse(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public SaleResponse(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public SaleResponse(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public SaleResponse(SaleResponse src) {
    this();
   ...
   */
  public SaleResponse copyChanges() {
    SaleResponse copy = new SaleResponse();
   ...
   */
  public void mergeChanges(SaleResponse src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new SaleResponse(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<SaleResponse> CREATOR = new android.os.Parcelable.Creator<SaleResponse>() {
    @Override
    public SaleResponse createFromParcel(android.os.Parcel in) {
      SaleResponse instance = new SaleResponse(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
  ...
  public static final com.clover.sdk.JSONifiable.Creator<SaleResponse> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<SaleResponse>() {
    @Override
    public SaleResponse create(org.json.JSONObject jsonObject) {
      return new SaleResponse(jsonObject);
    }
  };
