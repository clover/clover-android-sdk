...
public class TipAdded extends com.clover.sdk.v3.remotepay.BaseResponse {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<TipAdded> {
    tipAmount {
      @Override
      public Object extractValue(TipAdded instance) {
  ...
  private GenericClient<TipAdded> genClient;
  ...
  */
  public TipAdded() {
    super(false);
    genClient = new GenericClient<TipAdded>(this);
  }
  ...
  * Constructs a new empty instance.
  */
  protected TipAdded(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public TipAdded(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public TipAdded(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public TipAdded setTipAmount(java.lang.Long tipAmount) {
   ...
   */
  public TipAdded copyChanges() {
    TipAdded copy = new TipAdded();
   ...
   */
  public void mergeChanges(TipAdded src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new TipAdded(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<TipAdded> CREATOR = new android.os.Parcelable.Creator<TipAdded>() {
    @Override
    public TipAdded createFromParcel(android.os.Parcel in) {
      TipAdded instance = new TipAdded(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public TipAdded[] newArray(int size) {
      return new TipAdded[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<TipAdded> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<TipAdded>() {
    @Override
    public TipAdded create(org.json.JSONObject jsonObject) {
      return new TipAdded(jsonObject);
    }
  };
