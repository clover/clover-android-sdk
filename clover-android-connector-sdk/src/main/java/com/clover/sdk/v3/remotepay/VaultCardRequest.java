...
public class VaultCardRequest extends com.clover.sdk.v3.remotepay.BaseRequest {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<VaultCardRequest> {
    cardEntryMethods {
      @Override
      public Object extractValue(VaultCardRequest instance) {
  ...
  private GenericClient<VaultCardRequest> genClient;
  ...
  */
  public VaultCardRequest() {
    super(false);
    genClient = new GenericClient<VaultCardRequest>(this);
  }
  ...
  * Constructs a new empty instance.
  */
  protected VaultCardRequest(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public VaultCardRequest(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public VaultCardRequest(VaultCardRequest src) {
    this();
  ...
  public VaultCardRequest copyChanges() {
    VaultCardRequest copy = new VaultCardRequest();
   ...
   */
  public void mergeChanges(VaultCardRequest src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new VaultCardRequest(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<VaultCardRequest> CREATOR = new android.os.Parcelable.Creator<VaultCardRequest>() {
    @Override
    public VaultCardRequest createFromParcel(android.os.Parcel in) {
      VaultCardRequest instance = new VaultCardRequest(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public VaultCardRequest[] newArray(int size) {
      return new VaultCardRequest[size];
    }
  };
