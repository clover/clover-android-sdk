...
public class BaseResponse extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<BaseResponse> {
    success {
      @Override
      public Object extractValue(BaseResponse instance) {
  ...
  private GenericClient<BaseResponse> genClient;
