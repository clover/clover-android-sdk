...
public class WelcomeMessage extends com.clover.sdk.v3.remotemessage.Message {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<WelcomeMessage> {
    method {
      @Override
      public Object extractValue(WelcomeMessage instance) {
  ...
  private GenericClient<WelcomeMessage> genClient;
  ...
  */
  public WelcomeMessage() {
    super(false);
    genClient = new GenericClient<WelcomeMessage>(this);
    this.setMethod(com.clover.sdk.v3.remotemessage.Method.SHOW_WELCOME_SCREEN);
  }
  ...
  * Constructs a new empty instance.
  */
  protected WelcomeMessage(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public WelcomeMessage(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public WelcomeMessage(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public WelcomeMessage(WelcomeMessage src) {
    this();
   ...
   */
  public WelcomeMessage copyChanges() {
    WelcomeMessage copy = new WelcomeMessage();
   ...
   */
  public void mergeChanges(WelcomeMessage src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new WelcomeMessage(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<WelcomeMessage> CREATOR = new android.os.Parcelable.Creator<WelcomeMessage>() {
    @Override
    public WelcomeMessage createFromParcel(android.os.Parcel in) {
      WelcomeMessage instance = new WelcomeMessage(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
  ...
  public static final com.clover.sdk.JSONifiable.Creator<WelcomeMessage> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<WelcomeMessage>() {
    @Override
    public WelcomeMessage create(org.json.JSONObject jsonObject) {
      return new WelcomeMessage(jsonObject);
    }
  };
