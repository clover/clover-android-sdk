...
public class ReadCardDataRequest extends com.clover.sdk.v3.remotepay.BaseRequest {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<ReadCardDataRequest> {
    isForceSwipePinEntry {
      @Override
      public Object extractValue(ReadCardDataRequest instance) {
  ...
  private GenericClient<ReadCardDataRequest> genClient;
