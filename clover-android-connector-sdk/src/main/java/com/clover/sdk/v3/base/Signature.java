...
public class Signature extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<Signature> {
    strokes {
      @Override
      public Object extractValue(Signature instance) {
        return instance.genClient.extractListRecord("strokes", com.clover.sdk.v3.base.Points.JSON_CREATOR);
      }
    },
    width {
      @Override
