...
public class MessageFromActivity extends com.clover.sdk.v3.remotepay.ActivityMessage {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<MessageFromActivity> {
    action {
      @Override
  ...
  private GenericClient<MessageFromActivity> genClient;

  /**
  * Constructs a new empty instance.
  */
  public MessageFromActivity() {
    super(false);
    genClient = new GenericClient<MessageFromActivity>(this);
  }
  ...
  * Constructs a new empty instance.
  */
  protected MessageFromActivity(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public MessageFromActivity(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public MessageFromActivity(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public MessageFromActivity(MessageFromActivity src) {
    this();
   ...
   */
  public MessageFromActivity copyChanges() {
    MessageFromActivity copy = new MessageFromActivity();
   ...
   */
  public void mergeChanges(MessageFromActivity src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new MessageFromActivity(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<MessageFromActivity> CREATOR = new android.os.Parcelable.Creator<MessageFromActivity>() {
    @Override
    public MessageFromActivity createFromParcel(android.os.Parcel in) {
      MessageFromActivity instance = new MessageFromActivity(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public MessageFromActivity[] newArray(int size) {
      return new MessageFromActivity[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<MessageFromActivity> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<MessageFromActivity>() {
    @Override
    public MessageFromActivity create(org.json.JSONObject jsonObject) {
      return new MessageFromActivity(jsonObject);
    }
  };
