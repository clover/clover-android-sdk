...
public class CapturePreAuthMessage extends com.clover.sdk.v3.remotemessage.Message {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<CapturePreAuthMessage> {
    amount {
      @Override
      public Object extractValue(CapturePreAuthMessage instance) {
  ...
  private GenericClient<CapturePreAuthMessage> genClient;

  /**
  * Constructs a new empty instance.
  */
  public CapturePreAuthMessage() {
    super(false);
    genClient = new GenericClient<CapturePreAuthMessage>(this);
    this.setMethod(com.clover.sdk.v3.remotemessage.Method.CAPTURE_PREAUTH);
  }
  ...
  * Constructs a new empty instance.
  */
  protected CapturePreAuthMessage(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public CapturePreAuthMessage(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public CapturePreAuthMessage(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public CapturePreAuthMessage(CapturePreAuthMessage src) {
    this();
   ...
   */
  public CapturePreAuthMessage setAmount(java.lang.Long amount) {
   ...
   */
  public CapturePreAuthMessage setTipAmount(java.lang.Long tipAmount) {
   ...
   */
  public CapturePreAuthMessage setPaymentId(java.lang.String paymentId) {
   ...
   */
  public CapturePreAuthMessage copyChanges() {
    CapturePreAuthMessage copy = new CapturePreAuthMessage();
   ...
   */
  public void mergeChanges(CapturePreAuthMessage src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new CapturePreAuthMessage(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<CapturePreAuthMessage> CREATOR = new android.os.Parcelable.Creator<CapturePreAuthMessage>() {
    @Override
    public CapturePreAuthMessage createFromParcel(android.os.Parcel in) {
      CapturePreAuthMessage instance = new CapturePreAuthMessage(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public CapturePreAuthMessage[] newArray(int size) {
      return new CapturePreAuthMessage[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<CapturePreAuthMessage> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<CapturePreAuthMessage>() {
    @Override
    public CapturePreAuthMessage create(org.json.JSONObject jsonObject) {
      return new CapturePreAuthMessage(jsonObject);
    }
  };
