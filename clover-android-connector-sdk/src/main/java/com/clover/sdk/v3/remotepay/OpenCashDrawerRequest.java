...
public class OpenCashDrawerRequest extends com.clover.sdk.v3.remotepay.BaseRequest {
   ...
   */
  public OpenCashDrawerRequest(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public OpenCashDrawerRequest(OpenCashDrawerRequest src) {
    this();
   ...
   */
  public OpenCashDrawerRequest setReason(java.lang.String reason) {
   ...
   */
  public OpenCashDrawerRequest setDeviceId(java.lang.String deviceId) {
   ...
   */
  public OpenCashDrawerRequest copyChanges() {
    OpenCashDrawerRequest copy = new OpenCashDrawerRequest();
   ...
   */
  public void mergeChanges(OpenCashDrawerRequest src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new OpenCashDrawerRequest(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<OpenCashDrawerRequest> CREATOR = new android.os.Parcelable.Creator<OpenCashDrawerRequest>() {
    @Override
    public OpenCashDrawerRequest createFromParcel(android.os.Parcel in) {
      OpenCashDrawerRequest instance = new OpenCashDrawerRequest(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public OpenCashDrawerRequest[] newArray(int size) {
      return new OpenCashDrawerRequest[size];
    }
  };
