...
public class BreakMessage extends com.clover.sdk.v3.remotemessage.Message {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<BreakMessage> {
    method {
      @Override
      public Object extractValue(BreakMessage instance) {
  ...
  private GenericClient<BreakMessage> genClient;
  ...
  */
  public BreakMessage() {
    super(false);
    genClient = new GenericClient<BreakMessage>(this);
    this.setMethod(com.clover.sdk.v3.remotemessage.Method.BREAK);
  }
  ...
  * Constructs a new empty instance.
  */
  protected BreakMessage(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public BreakMessage(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public BreakMessage(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public BreakMessage(BreakMessage src) {
    this();
   ...
   */
  public BreakMessage copyChanges() {
    BreakMessage copy = new BreakMessage();
   ...
   */
  public void mergeChanges(BreakMessage src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new BreakMessage(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<BreakMessage> CREATOR = new android.os.Parcelable.Creator<BreakMessage>() {
    @Override
    public BreakMessage createFromParcel(android.os.Parcel in) {
      BreakMessage instance = new BreakMessage(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public BreakMessage[] newArray(int size) {
      return new BreakMessage[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<BreakMessage> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<BreakMessage>() {
    @Override
    public BreakMessage create(org.json.JSONObject jsonObject) {
      return new BreakMessage(jsonObject);
    }
  };
