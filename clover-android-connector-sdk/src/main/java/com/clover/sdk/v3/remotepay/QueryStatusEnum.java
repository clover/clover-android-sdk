...
public class QueryStatusEnum extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<QueryStatusEnum> {
    queryStatus {
      @Override
      public Object extractValue(QueryStatusEnum instance) {
  ...
  private GenericClient<QueryStatusEnum> genClient;
