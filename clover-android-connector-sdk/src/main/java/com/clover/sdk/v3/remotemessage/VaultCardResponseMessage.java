...
public class VaultCardResponseMessage extends com.clover.sdk.v3.remotemessage.Message {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<VaultCardResponseMessage> {
    reason {
      @Override
      public Object extractValue(VaultCardResponseMessage instance) {
    ...
    card {
      @Override
      public Object extractValue(VaultCardResponseMessage instance) {
        return instance.genClient.extractRecord("card", com.clover.sdk.v3.payments.VaultedCard.JSON_CREATOR);
      }
    },
    method {
      @Override
  ...
  private GenericClient<VaultCardResponseMessage> genClient;
  ...
  */
  public VaultCardResponseMessage() {
    super(false);
    genClient = new GenericClient<VaultCardResponseMessage>(this);
    this.setMethod(com.clover.sdk.v3.remotemessage.Method.VAULT_CARD_RESPONSE);
  }
  ...
  * Constructs a new empty instance.
  */
  protected VaultCardResponseMessage(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public VaultCardResponseMessage(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public VaultCardResponseMessage(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public VaultCardResponseMessage(VaultCardResponseMessage src) {
    this();
   ...
   */
  public VaultCardResponseMessage setReason(java.lang.String reason) {
   ...
   */
  public VaultCardResponseMessage setStatus(com.clover.sdk.v3.remotemessage.ResultStatus status) {
   ...
   */
  public VaultCardResponseMessage setCard(com.clover.sdk.v3.payments.VaultedCard card) {
   ...
   */
  public VaultCardResponseMessage copyChanges() {
    VaultCardResponseMessage copy = new VaultCardResponseMessage();
   ...
   */
  public void mergeChanges(VaultCardResponseMessage src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new VaultCardResponseMessage(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<VaultCardResponseMessage> CREATOR = new android.os.Parcelable.Creator<VaultCardResponseMessage>() {
    @Override
    public VaultCardResponseMessage createFromParcel(android.os.Parcel in) {
      VaultCardResponseMessage instance = new VaultCardResponseMessage(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public VaultCardResponseMessage[] newArray(int size) {
      return new VaultCardResponseMessage[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<VaultCardResponseMessage> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<VaultCardResponseMessage>() {
    @Override
    public VaultCardResponseMessage create(org.json.JSONObject jsonObject) {
      return new VaultCardResponseMessage(jsonObject);
    }
  };
