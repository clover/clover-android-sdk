...
public class PrintJobStatusResponseMessage extends com.clover.sdk.v3.remotemessage.Message {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<PrintJobStatusResponseMessage> {
    externalPrintJobId {
      @Override
  ...
  */
  public PrintJobStatusResponseMessage() {
    super(false);
    genClient = new GenericClient<PrintJobStatusResponseMessage>(this);
    this.setMethod(com.clover.sdk.v3.remotemessage.Method.PRINT_JOB_STATUS_RESPONSE);
  }
  ...
  * Constructs a new empty instance.
  */
  protected PrintJobStatusResponseMessage(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public PrintJobStatusResponseMessage(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public PrintJobStatusResponseMessage(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public PrintJobStatusResponseMessage(PrintJobStatusResponseMessage src) {
    this();
   ...
   */
  public PrintJobStatusResponseMessage setExternalPrintJobId(java.lang.String externalPrintJobId) {
  ...
  public PrintJobStatusResponseMessage copyChanges() {
    PrintJobStatusResponseMessage copy = new PrintJobStatusResponseMessage();
   ...
   */
  public void mergeChanges(PrintJobStatusResponseMessage src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new PrintJobStatusResponseMessage(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<PrintJobStatusResponseMessage> CREATOR = new android.os.Parcelable.Creator<PrintJobStatusResponseMessage>() {
    @Override
    public PrintJobStatusResponseMessage createFromParcel(android.os.Parcel in) {
      PrintJobStatusResponseMessage instance = new PrintJobStatusResponseMessage(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public PrintJobStatusResponseMessage[] newArray(int size) {
      return new PrintJobStatusResponseMessage[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<PrintJobStatusResponseMessage> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<PrintJobStatusResponseMessage>() {
    @Override
    public PrintJobStatusResponseMessage create(org.json.JSONObject jsonObject) {
