...
public class VaultCardResponse extends com.clover.sdk.v3.remotepay.BaseResponse {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<VaultCardResponse> {
    card {
      @Override
      public Object extractValue(VaultCardResponse instance) {
  ...
  private GenericClient<VaultCardResponse> genClient;
