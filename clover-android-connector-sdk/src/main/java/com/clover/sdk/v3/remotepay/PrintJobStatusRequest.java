...
public class PrintJobStatusRequest extends com.clover.sdk.v3.remotepay.BaseRequest {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<PrintJobStatusRequest> {
    printRequestId {
      @Override
      public Object extractValue(PrintJobStatusRequest instance) {
  ...
  private GenericClient<PrintJobStatusRequest> genClient;
  ...
  */
  public PrintJobStatusRequest() {
    super(false);
    genClient = new GenericClient<PrintJobStatusRequest>(this);
  }
  ...
  * Constructs a new empty instance.
  */
  protected PrintJobStatusRequest(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public PrintJobStatusRequest(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public PrintJobStatusRequest(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public PrintJobStatusRequest(PrintJobStatusRequest src) {
    this();
   ...
   */
  public PrintJobStatusRequest setPrintRequestId(java.lang.String printRequestId) {
   ...
   */
  public PrintJobStatusRequest copyChanges() {
    PrintJobStatusRequest copy = new PrintJobStatusRequest();
   ...
   */
  public void mergeChanges(PrintJobStatusRequest src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new PrintJobStatusRequest(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<PrintJobStatusRequest> CREATOR = new android.os.Parcelable.Creator<PrintJobStatusRequest>() {
    @Override
    public PrintJobStatusRequest createFromParcel(android.os.Parcel in) {
      PrintJobStatusRequest instance = new PrintJobStatusRequest(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public PrintJobStatusRequest[] newArray(int size) {
      return new PrintJobStatusRequest[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<PrintJobStatusRequest> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<PrintJobStatusRequest>() {
    @Override
    public PrintJobStatusRequest create(org.json.JSONObject jsonObject) {
      return new PrintJobStatusRequest(jsonObject);
    }
  };
