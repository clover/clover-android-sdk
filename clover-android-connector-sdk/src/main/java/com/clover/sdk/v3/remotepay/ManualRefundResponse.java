...
public class ManualRefundResponse extends com.clover.sdk.v3.remotepay.BaseResponse {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<ManualRefundResponse> {
    credit {
      @Override
      public Object extractValue(ManualRefundResponse instance) {
  ...
  private GenericClient<ManualRefundResponse> genClient;

  /**
  * Constructs a new empty instance.
  */
  public ManualRefundResponse() {
    super(false);
    genClient = new GenericClient<ManualRefundResponse>(this);
  }
  ...
  * Constructs a new empty instance.
  */
  protected ManualRefundResponse(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public ManualRefundResponse(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public ManualRefundResponse(ManualRefundResponse src) {
    this();
   ...
   */
  public ManualRefundResponse setCredit(com.clover.sdk.v3.payments.Credit credit) {
   ...
   */
  public ManualRefundResponse copyChanges() {
    ManualRefundResponse copy = new ManualRefundResponse();
   ...
   */
  public void mergeChanges(ManualRefundResponse src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new ManualRefundResponse(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<ManualRefundResponse> CREATOR = new android.os.Parcelable.Creator<ManualRefundResponse>() {
    @Override
    public ManualRefundResponse createFromParcel(android.os.Parcel in) {
      ManualRefundResponse instance = new ManualRefundResponse(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public ManualRefundResponse[] newArray(int size) {
      return new ManualRefundResponse[size];
    }
  };
