...
public class CashbackSelectedMessage extends com.clover.sdk.v3.remotemessage.Message {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<CashbackSelectedMessage> {
    cashbackAmount {
      @Override
      public Object extractValue(CashbackSelectedMessage instance) {
  ...
  private GenericClient<CashbackSelectedMessage> genClient;
  ...
  */
  public CashbackSelectedMessage() {
    super(false);
    genClient = new GenericClient<CashbackSelectedMessage>(this);
    this.setMethod(com.clover.sdk.v3.remotemessage.Method.CASHBACK_SELECTED);
  }
  ...
  * Constructs a new empty instance.
  */
  protected CashbackSelectedMessage(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public CashbackSelectedMessage(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public CashbackSelectedMessage(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public CashbackSelectedMessage(CashbackSelectedMessage src) {
    this();
   ...
   */
  public CashbackSelectedMessage setCashbackAmount(java.lang.Long cashbackAmount) {
   ...
   */
  public CashbackSelectedMessage copyChanges() {
    CashbackSelectedMessage copy = new CashbackSelectedMessage();
   ...
   */
  public void mergeChanges(CashbackSelectedMessage src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new CashbackSelectedMessage(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<CashbackSelectedMessage> CREATOR = new android.os.Parcelable.Creator<CashbackSelectedMessage>() {
    @Override
    public CashbackSelectedMessage createFromParcel(android.os.Parcel in) {
      CashbackSelectedMessage instance = new CashbackSelectedMessage(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public CashbackSelectedMessage[] newArray(int size) {
      return new CashbackSelectedMessage[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<CashbackSelectedMessage> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<CashbackSelectedMessage>() {
    @Override
    public CashbackSelectedMessage create(org.json.JSONObject jsonObject) {
      return new CashbackSelectedMessage(jsonObject);
    }
  };
