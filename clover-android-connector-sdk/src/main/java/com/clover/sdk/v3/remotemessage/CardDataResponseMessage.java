 ...
 * <li>{@link #getCardData cardData}</li>
 * </ul>
 */
@SuppressWarnings("all")
public class CardDataResponseMessage extends com.clover.sdk.v3.remotemessage.Message {
   ...
   */
  public com.clover.sdk.v3.base.CardData getCardData() {
    return genClient.cacheGet(CacheKey.cardData);
  }
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<CardDataResponseMessage> {
    reason {
      @Override
      public Object extractValue(CardDataResponseMessage instance) {
    ...
    cardData {
      @Override
      public Object extractValue(CardDataResponseMessage instance) {
        return instance.genClient.extractRecord("cardData", com.clover.sdk.v3.base.CardData.JSON_CREATOR);
      }
    },
    method {
      @Override
  ...
  */
  public CardDataResponseMessage() {
    super(false);
    genClient = new GenericClient<CardDataResponseMessage>(this);
    this.setMethod(com.clover.sdk.v3.remotemessage.Method.CARD_DATA_RESPONSE);
  }
  ...
  * Constructs a new empty instance.
  */
  protected CardDataResponseMessage(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public CardDataResponseMessage(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public CardDataResponseMessage(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public CardDataResponseMessage(CardDataResponseMessage src) {
    this();
  ...
  /** Checks whether the 'cardData' field is set and is not null */
  public boolean isNotNullCardData() {
    return genClient.cacheValueIsNotNull(CacheKey.cardData);
  }
  ...
  /** Checks whether the 'cardData' field has been set, however the value could be null */
  public boolean hasCardData() {
    return genClient.cacheHasKey(CacheKey.cardData);
  }
   ...
   */
  public CardDataResponseMessage setReason(java.lang.String reason) {
   ...
   */
  public CardDataResponseMessage setStatus(com.clover.sdk.v3.remotemessage.ResultStatus status) {
    return genClient.setOther(status, CacheKey.status);
  }

  /**
   * Sets the field 'cardData'.
   *
   * The parameter is not copied so changes to it will be reflected in this instance and vice-versa.
   */
  public CardDataResponseMessage setCardData(com.clover.sdk.v3.base.CardData cardData) {
    return genClient.setRecord(cardData, CacheKey.cardData);
  }
  ...
  /** Clears the 'cardData' field, the 'has' method for this field will now return false */
  public void clearCardData() {
    genClient.clear(CacheKey.cardData);
  }
  ...
  public CardDataResponseMessage copyChanges() {
    CardDataResponseMessage copy = new CardDataResponseMessage();
   ...
   */
  public void mergeChanges(CardDataResponseMessage src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new CardDataResponseMessage(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<CardDataResponseMessage> CREATOR = new android.os.Parcelable.Creator<CardDataResponseMessage>() {
    @Override
    public CardDataResponseMessage createFromParcel(android.os.Parcel in) {
      CardDataResponseMessage instance = new CardDataResponseMessage(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public CardDataResponseMessage[] newArray(int size) {
      return new CardDataResponseMessage[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<CardDataResponseMessage> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<CardDataResponseMessage>() {
    @Override
    public CardDataResponseMessage create(org.json.JSONObject jsonObject) {
