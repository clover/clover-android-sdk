...
public class Points extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<Points> {
    points {
      @Override
      public Object extractValue(Points instance) {
        return instance.genClient.extractListRecord("points", com.clover.sdk.v3.base.Point.JSON_CREATOR);
      }
    },
      ;
  }

  private GenericClient<Points> genClient;
