...
public class ActivityMessageToActivity extends com.clover.sdk.v3.remotemessage.Message {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<ActivityMessageToActivity> {
    action {
      @Override
      public Object extractValue(ActivityMessageToActivity instance) {
  ...
  */
  public ActivityMessageToActivity() {
    super(false);
    genClient = new GenericClient<ActivityMessageToActivity>(this);
    this.setMethod(com.clover.sdk.v3.remotemessage.Method.ACTIVITY_MESSAGE_TO_ACTIVITY);
  }
  ...
  * Constructs a new empty instance.
  */
  protected ActivityMessageToActivity(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public ActivityMessageToActivity(String json) throws IllegalArgumentException {
    this();
    try {
   ...
   */
  public ActivityMessageToActivity(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public ActivityMessageToActivity(ActivityMessageToActivity src) {
    this();
   ...
   */
  public ActivityMessageToActivity setAction(java.lang.String action) {
   ...
   */
  public ActivityMessageToActivity setPayload(java.lang.String payload) {
  ...
  public ActivityMessageToActivity copyChanges() {
    ActivityMessageToActivity copy = new ActivityMessageToActivity();
   ...
   */
  public void mergeChanges(ActivityMessageToActivity src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new ActivityMessageToActivity(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<ActivityMessageToActivity> CREATOR = new android.os.Parcelable.Creator<ActivityMessageToActivity>() {
    @Override
    public ActivityMessageToActivity createFromParcel(android.os.Parcel in) {
      ActivityMessageToActivity instance = new ActivityMessageToActivity(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public ActivityMessageToActivity[] newArray(int size) {
      return new ActivityMessageToActivity[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<ActivityMessageToActivity> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<ActivityMessageToActivity>() {
    @Override
    public ActivityMessageToActivity create(org.json.JSONObject jsonObject) {
  ...
  public interface Constraints {
    ...
    public static final boolean ACTIVITYID_IS_REQUIRED = false;
