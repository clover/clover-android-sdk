...
public class VoidPaymentRefundResponse extends com.clover.sdk.v3.remotepay.VoidPaymentResponse {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<VoidPaymentRefundResponse> {
    refundId {
      @Override
      public Object extractValue(VoidPaymentRefundResponse instance) {
        return instance.genClient.extractOther("refundId", java.lang.String.class);
      }
    },
    paymentId {
      @Override
  ...
  private GenericClient<VoidPaymentRefundResponse> genClient;

  /**
   * Constructs a new empty instance.
   */
  public VoidPaymentRefundResponse() {
    super(false);
    genClient = new GenericClient<VoidPaymentRefundResponse>(this);
  }
   ...
   * Constructs a new empty instance.
   */
  protected VoidPaymentRefundResponse(boolean noInit) {
    super(false);
    genClient = null;
  }
   ...
   */
  public VoidPaymentRefundResponse(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public VoidPaymentRefundResponse(VoidPaymentRefundResponse src) {
    this();
   ...
   */
  public VoidPaymentRefundResponse setRefundId(java.lang.String refundId) {
   ...
   */
  public VoidPaymentRefundResponse copyChanges() {
    VoidPaymentRefundResponse copy = new VoidPaymentRefundResponse();
   ...
   */
  public void mergeChanges(VoidPaymentRefundResponse src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new VoidPaymentRefundResponse(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<VoidPaymentRefundResponse> CREATOR = new android.os.Parcelable.Creator<VoidPaymentRefundResponse>() {
    @Override
    public VoidPaymentRefundResponse createFromParcel(android.os.Parcel in) {
      VoidPaymentRefundResponse instance = new VoidPaymentRefundResponse(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public VoidPaymentRefundResponse[] newArray(int size) {
      return new VoidPaymentRefundResponse[size];
    }
  };
