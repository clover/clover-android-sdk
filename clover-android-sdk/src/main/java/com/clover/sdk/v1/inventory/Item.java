...
public class Item implements android.os.Parcelable {
  ...
  public Item(java.lang.String name, java.lang.String alternateName, java.lang.String code, java.lang.Long price, com.clover.sdk.v1.inventory.PriceType priceType, java.lang.Boolean taxable, java.lang.Boolean defaultTaxRates, java.lang.String unitName, java.lang.Long cost) throws org.json.JSONException {
    ...
    if (price == null) throw new IllegalArgumentException("'price' is required to be non-null");
    if (taxable == null) throw new IllegalArgumentException("'taxable' is required to be non-null");
    setName(name);
  ...
  public void validate() {
    if (getName() == null) throw new IllegalArgumentException("'name' is required to be non-null");
    if (getPrice() == null) throw new IllegalArgumentException("'price' is required to be non-null");
    if (getTaxable() == null) throw new IllegalArgumentException("'taxable' is required to be non-null");
  ...
  public void setPrice(java.lang.Long price) throws org.json.JSONException {
    if (price < 0) throw new IllegalArgumentException("Invalid value for 'price'");
