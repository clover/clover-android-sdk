...
public class DeviceAccessory extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<DeviceAccessory> {
    id {
      @Override
      public Object extractValue(DeviceAccessory instance) {
    ...
    associatedDevice {
      @Override
      public Object extractValue(DeviceAccessory instance) {
        return instance.genClient.extractRecord("associatedDevice", com.clover.sdk.v3.base.Reference.JSON_CREATOR);
      }
    },
    cpuId {
      @Override
    ...
    buildType {
      @Override
      public Object extractValue(DeviceAccessory instance) {
        return instance.genClient.extractEnum("buildType", com.clover.sdk.v3.device.DeviceAccessoryBuildType.class);
      }
    },
    deviceType {
      @Override
    ...
    versionCode {
      @Override
      public Object extractValue(DeviceAccessory instance) {
        return instance.genClient.extractOther("versionCode", java.lang.Long.class);
      }
    },
    currentRom {
      @Override
      public Object extractValue(DeviceAccessory instance) {
        return instance.genClient.extractRecord("currentRom", com.clover.sdk.v3.base.Reference.JSON_CREATOR);
      }
    },
    secureReports {
      @Override
