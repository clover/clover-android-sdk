...
public class ItemSalesBucket extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<ItemSalesBucket> {
    name {
      @Override
      public Object extractValue(ItemSalesBucket instance) {
  ...
  private GenericClient<ItemSalesBucket> genClient;
