...
public class AdditionalCharge extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  /**
   * Optional percent to charge times 100000, e.g. 12.5% will be 1250000
   */
  ...
  public void validate() {
    ...
    if (getPercentageDecimal() != null && ( getPercentageDecimal() < 0 || getPercentageDecimal() > 10000000)) throw new IllegalArgumentException("Invalid value for 'getPercentageDecimal()'");
  }
  ...
  public interface Constraints {
    ...
    public static final long PERCENTAGEDECIMAL_MAX = 10000000;
