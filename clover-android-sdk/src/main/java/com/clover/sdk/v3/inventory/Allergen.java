 ...
 * <p>
 * Class to support managing Allergen information
 * <p>
 * <h3>Fields</h3>
 * <ul>
 * <li>{@link #getId id}</li>
...
public class Allergen extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  /**
   * Locale specific id for the allergen
   */
  ...
  /**
   * Timestamp when allergen was last created
   */
  ...
  /**
   * Timestamp when allergen was last modified
   */
  ...
  /**
   * Timestamp when allergen was last deleted
   */
  ...
  private final GenericClient<Allergen> genClient;

  /**
   * Constructs a new empty instance.
   */
  public Allergen() {
    genClient = new GenericClient<Allergen>(this);
  }
   ...
   * Constructs a new empty instance.
   */
  protected Allergen(boolean noInit) {
    genClient = null;
  }
   ...
   */
  public Allergen(String json) throws IllegalArgumentException {
    this();
   ...
   */
  public Allergen(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public Allergen setCreatedTime(java.lang.Long createdTime) {
   ...
   */
  public Allergen setModifiedTime(java.lang.Long modifiedTime) {
   ...
   */
  public Allergen setDeletedTime(java.lang.Long deletedTime) {
   ...
   */
  public void mergeChanges(Allergen src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new Allergen(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<Allergen> CREATOR = new android.os.Parcelable.Creator<Allergen>() {
    @Override
    public Allergen createFromParcel(android.os.Parcel in) {
      Allergen instance = new Allergen(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
  ...
  public static final com.clover.sdk.JSONifiable.Creator<Allergen> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<Allergen>() {
    public Class<Allergen> getCreatedClass() {
      return Allergen.class;
    }

    @Override
    public Allergen create(org.json.JSONObject jsonObject) {
      return new Allergen(jsonObject);
    }
  };
