...
package com.clover.sdk.v3.permission;
...
public final class PermissionSet implements android.os.Parcelable, com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  public static final String AUTHORITY = "com.clover.permissions";
  ...
  private enum CacheKey {
    ...
    permissions {
      @Override
      public Object extractValue(PermissionSet instance) {
        return instance.extractPermissions();
      }
    },
    ;
  ...
  public PermissionSet(PermissionSet src) {
    this.jsonString = src.jsonString != null ? src.jsonString : src.getJSONObject().toString();
  }
   ...
   * The returned object is not a copy so changes to it will be reflected in this instance and vice-versa.
   */
  public com.clover.sdk.v3.permission.Permissions getPermissions() {
    return cacheGet(CacheKey.permissions);
  }

  private com.clover.sdk.v3.permission.Permissions extractPermissions() {
    org.json.JSONObject jsonObj = getJSONObject().optJSONObject("permissions");
    if (jsonObj != null) {
      return new com.clover.sdk.v3.permission.Permissions(getJSONObject().optJSONObject("permissions"));
    }
    return null;
  }
  ...
  public boolean isNotNullPermissions() {
    return cacheValueIsNotNull(CacheKey.permissions);
  }
  ...
  public boolean hasPermissions() {
    return cacheHasKey(CacheKey.permissions);
  }
   ...
   * The parameter is not copied so changes to it will be reflected in this instance and vice-versa.
   */
  public PermissionSet setPermissions(com.clover.sdk.v3.permission.Permissions permissions) {
    logChange("permissions");

    try {
      getJSONObject().put("permissions",
          permissions == null ? org.json.JSONObject.NULL : permissions.getJSONObject());
    } catch (org.json.JSONException e) {
      throw new java.lang.IllegalArgumentException(e);
    }

    cacheMarkDirty(CacheKey.permissions);
    return this;
  }
  ...
  public void clearPermissions() {
    unlogChange("permissions");
    getJSONObject().remove("permissions");
    cacheRemoveValue(CacheKey.permissions);
  }
  ...
  public static final android.os.Parcelable.Creator<PermissionSet> CREATOR = new android.os.Parcelable.Creator<PermissionSet>() {
    ...
    public PermissionSet createFromParcel(android.os.Parcel in) {
      ...
      PermissionSet instance = new PermissionSet(json);
