...
public class ModifierGroupArray extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<ModifierGroupArray> {
    modifierGroups {
      @Override
      public Object extractValue(ModifierGroupArray instance) {
  ...
  private GenericClient<ModifierGroupArray> genClient;
