...
public enum LineItemType implements Parcelable {
  REGULAR, RESTAURANT, SERVICE, RETAIL, BUNDLE;
  ...
  public static final Creator<LineItemType> CREATOR = new Creator<LineItemType>() {
    @Override
    public LineItemType createFromParcel(final Parcel source) {
      return LineItemType.valueOf(source.readString());
    }

    @Override
    public LineItemType[] newArray(final int size) {
