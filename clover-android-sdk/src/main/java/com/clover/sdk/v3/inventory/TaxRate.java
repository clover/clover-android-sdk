 ...
 * <li>{@link #getSystemTaxRate systemTaxRate}</li>
...
public class TaxRate extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  /**
   * System tax rates associated with this tax
   */
  public com.clover.sdk.v3.inventory.SystemTaxRate getSystemTaxRate() {
    return genClient.cacheGet(CacheKey.systemTaxRate);
  }
  ...
  private enum CacheKey implements com.clover.sdk.ExtractionStrategyEnum {
    ...
    taxAmount
        (com.clover.sdk.extractors.BasicExtractionStrategy.instance(java.lang.Long.class)),
    systemTaxRate
        (com.clover.sdk.extractors.RecordExtractionStrategy.instance(com.clover.sdk.v3.inventory.SystemTaxRate.JSON_CREATOR)),
    deletedTime
        (com.clover.sdk.extractors.BasicExtractionStrategy.instance(java.lang.Long.class)),
    modifiedTime
        (com.clover.sdk.extractors.BasicExtractionStrategy.instance(java.lang.Long.class)),
  ...
  /** Checks whether the 'systemTaxRate' field is set and is not null */
  public boolean isNotNullSystemTaxRate() {
    return genClient.cacheValueIsNotNull(CacheKey.systemTaxRate);
  }
  ...
  /** Checks whether the 'systemTaxRate' field has been set, however the value could be null */
  public boolean hasSystemTaxRate() {
    return genClient.cacheHasKey(CacheKey.systemTaxRate);
  }
  ...
  /**
   * Sets the field 'systemTaxRate'.
   *
   * The parameter is not copied so changes to it will be reflected in this instance and vice-versa.
   */
  public TaxRate setSystemTaxRate(com.clover.sdk.v3.inventory.SystemTaxRate systemTaxRate) {
    return genClient.setRecord(systemTaxRate, CacheKey.systemTaxRate);
  }
  ...
  /** Clears the 'systemTaxRate' field, the 'has' method for this field will now return false */
  public void clearSystemTaxRate() {
    genClient.clear(CacheKey.systemTaxRate);
  }
  ...
  public interface Constraints {
    ...
    public static final boolean SYSTEMTAXRATE_IS_REQUIRED = false;
