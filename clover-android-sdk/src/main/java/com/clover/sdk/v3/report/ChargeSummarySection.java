...
public class ChargeSummarySection extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
   ...
   */
  public java.util.List<com.clover.sdk.v3.report.ChargeSummary> getRows() {
  ...
  private final GenericClient<ChargeSummarySection> genClient;

  /**
   * Constructs a new empty instance.
   */
  public ChargeSummarySection() {
    genClient = new GenericClient<ChargeSummarySection>(this);
  }
   ...
   */
  public ChargeSummarySection setRows(java.util.List<com.clover.sdk.v3.report.ChargeSummary> rows) {
  ...
  public static final android.os.Parcelable.Creator<ChargeSummarySection> CREATOR = new android.os.Parcelable.Creator<ChargeSummarySection>() {
    @Override
  ...
  public static final com.clover.sdk.JSONifiable.Creator<ChargeSummarySection> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<ChargeSummarySection>() {
    public Class<ChargeSummarySection> getCreatedClass() {
