...
public class MerchantProgramExpress extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<MerchantProgramExpress> {
    merchantRef {
      @Override
      public Object extractValue(MerchantProgramExpress instance) {
    ...
    programCode {
      @Override
      public Object extractValue(MerchantProgramExpress instance) {
        return instance.genClient.extractOther("programCode", java.lang.String.class);
      }
    },
    programCodeDescription {
      @Override
      public Object extractValue(MerchantProgramExpress instance) {
        return instance.genClient.extractOther("programCodeDescription", java.lang.String.class);
      }
    },
    key {
      @Override
      public Object extractValue(MerchantProgramExpress instance) {
        return instance.genClient.extractOther("key", java.lang.String.class);
      }
    },
    keyDescription {
      @Override
      public Object extractValue(MerchantProgramExpress instance) {
        return instance.genClient.extractOther("keyDescription", java.lang.String.class);
      }
    },
    value {
      @Override
    ...
    valueDescription {
      @Override
      public Object extractValue(MerchantProgramExpress instance) {
        return instance.genClient.extractOther("valueDescription", java.lang.String.class);
      }
    },
      ;
  }
