 ...
 * <li>{@link #getPaymentCard paymentCard}</li>
 * </ul>
 */
...
public class CreditRequest extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  public com.clover.sdk.v3.pay.PaymentRequestCardDetails getPaymentCard() {
    return genClient.cacheGet(CacheKey.paymentCard);
  }
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<CreditRequest> {
    ...
    paymentCard {
      @Override
      public Object extractValue(CreditRequest instance) {
        return instance.genClient.extractRecord("paymentCard", com.clover.sdk.v3.pay.PaymentRequestCardDetails.JSON_CREATOR);
      }
    },
    ;
  }
  ...
  public boolean isNotNullPaymentCard() {
    return genClient.cacheValueIsNotNull(CacheKey.paymentCard);
  }
  ...
  public boolean hasPaymentCard() {
    return genClient.cacheHasKey(CacheKey.paymentCard);
  }
   ...
   * The parameter is not copied so changes to it will be reflected in this instance and vice-versa.
   */
  public CreditRequest setPaymentCard(com.clover.sdk.v3.pay.PaymentRequestCardDetails paymentCard) {
    return genClient.setRecord(paymentCard, CacheKey.paymentCard);
  }
  ...
  public void clearPaymentCard() {
    genClient.clear(CacheKey.paymentCard);
  }
