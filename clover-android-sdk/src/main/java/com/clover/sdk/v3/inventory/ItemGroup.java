  ...
  */
  ...
  private enum CacheKey {
    ...
    attributes {
      @Override
      public Object extractValue(ItemGroup instance) {
        return instance.extractAttributes();
      }
    },
    ;

    public abstract Object extractValue(ItemGroup instance);
  }
   ...
   */
  public ItemGroup(String json) throws java.lang.IllegalArgumentException {
    try {
  ...
  private java.util.List<com.clover.sdk.v3.base.Reference> extractAttributes() {
    ...
    org.json.JSONObject elementsContainer = getJSONObject().optJSONObject("attributes");
    org.json.JSONArray itemArray = elementsContainer.optJSONArray("elements");
    java.util.List<com.clover.sdk.v3.base.Reference> itemList =
        new java.util.ArrayList<com.clover.sdk.v3.base.Reference>(itemArray.length());
    for (int i = 0; i < itemArray.length(); i++) {
  ...
  public boolean isNotNullAttributes() {
    return cacheValueIsNotNull(CacheKey.attributes);
  }
  ...
  public boolean hasAttributes() {
    return cacheHasKey(CacheKey.attributes);
  }
  ...
  public ItemGroup setAttributes(java.util.List<com.clover.sdk.v3.base.Reference> attributes) {
    logChange("attributes");

    try {
      if (attributes == null) {
        getJSONObject().put("attributes", org.json.JSONObject.NULL);
        cacheMarkDirty(CacheKey.attributes);
        return this;
      }

      org.json.JSONArray array = new org.json.JSONArray();
      for (com.clover.sdk.v3.base.Reference obj : attributes) {
        if (obj == null) {
          continue;
        }
        array.put(obj.getJSONObject());
      ...
      org.json.JSONObject elementsContainer = new org.json.JSONObject();
      elementsContainer.put("elements", array);
      getJSONObject().put("attributes", elementsContainer);
    } catch (org.json.JSONException e) {
      throw new java.lang.IllegalArgumentException(e);
    }
  ...
  public void clearAttributes() {
    unlogChange("attributes");
    getJSONObject().remove("attributes");
    cacheRemoveValue(CacheKey.attributes);
  }
  ...
  public void mergeChanges(ItemGroup src) {
    if (src.changeLog != null) {
      try {
        ...
        org.json.JSONObject srcObj = new ItemGroup(src).getJSONObject();
