...
public class DisplayOrder extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  public java.util.List<com.clover.sdk.v3.order.DisplayOrderFeeItem> getOrderFeeItems() {
   ...
   * Nulls in the given List are skipped. List parameter is copied, so it will not reflect any changes, but objects inside it will.
   */
  public DisplayOrder setOrderFeeItems(java.util.List<com.clover.sdk.v3.order.DisplayOrderFeeItem> orderFeeItems) {
