...
public class GetCardEmvDataResponse extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
    ...
    private final GenericClient<GetCardEmvDataResponse> genClient;

    /**
     * Constructs a new empty instance.
     */
    public GetCardEmvDataResponse() {
        genClient = new GenericClient<GetCardEmvDataResponse>(this);
    }
    ...
    public static final android.os.Parcelable.Creator<GetCardEmvDataResponse> CREATOR = new android.os.Parcelable.Creator<GetCardEmvDataResponse>() {
        @Override
    ...
    public static final com.clover.sdk.JSONifiable.Creator<GetCardEmvDataResponse> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<GetCardEmvDataResponse>() {
        public Class<GetCardEmvDataResponse> getCreatedClass() {
