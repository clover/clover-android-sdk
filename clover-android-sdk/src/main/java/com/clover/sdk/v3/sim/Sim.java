...
public final class Sim implements android.os.Parcelable, com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  /**
   * If true, the SIM will be activated during the next BulkActivateSimsJob
   */
  public java.lang.Boolean getNeedsActivation() {
    return genClient.cacheGet(CacheKey.needsActivation);
  }
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<Sim> {
    ...
    needsActivation {
      @Override
      public Object extractValue(Sim instance) {
        return instance.genClient.extractOther("needsActivation", java.lang.Boolean.class);
      }
    },
    device {
      @Override
  ...
  /** Checks whether the 'needsActivation' field is set and is not null */
  public boolean isNotNullNeedsActivation() {
    return genClient.cacheValueIsNotNull(CacheKey.needsActivation);
  }
  ...
  /** Checks whether the 'needsActivation' field has been set, however the value could be null */
  public boolean hasNeedsActivation() {
    return genClient.cacheHasKey(CacheKey.needsActivation);
  }
  ...
  /**
   * Sets the field 'needsActivation'.
   */
  public Sim setNeedsActivation(java.lang.Boolean needsActivation) {
    return genClient.setOther(needsActivation, CacheKey.needsActivation);
  }
  ...
  /** Clears the 'needsActivation' field, the 'has' method for this field will now return false */
  public void clearNeedsActivation() {
    genClient.clear(CacheKey.needsActivation);
  }
  ...
  public interface Constraints {
    ...
    public static final boolean NEEDSACTIVATION_IS_REQUIRED = false;
