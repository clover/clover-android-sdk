...
public class Section extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<Section> {
    id {
      @Override
      public Object extractValue(Section instance) {
    ...
    deletable {
      @Override
      public Object extractValue(Section instance) {
        return instance.genClient.extractOther("deletable", java.lang.Boolean.class);
      }
    },
    tables {
      @Override
      public Object extractValue(Section instance) {
        return instance.genClient.extractListRecord("tables", com.clover.sdk.v3.tables2.Table.JSON_CREATOR);
      }
    },
      ;
  }

  private GenericClient<Section> genClient;
