 ...
 * <li>{@link #getDebitRefund debitRefund}</li>
 * </ul>
 */
...
public class CardTransaction extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
   ...
   */
  public com.clover.sdk.v3.payments.DebitRefund getDebitRefund() {
    return genClient.cacheGet(CacheKey.debitRefund);
  }
  ...
  /** Checks whether the 'debitRefund' field is set and is not null */
  public boolean isNotNullDebitRefund() {
    return genClient.cacheValueIsNotNull(CacheKey.debitRefund);
  }
  ...
  /** Checks whether the 'debitRefund' field has been set, however the value could be null */
  public boolean hasDebitRefund() {
    return genClient.cacheHasKey(CacheKey.debitRefund);
  }
  ...
  /**
   * Sets the field 'debitRefund'.
   *
   * The parameter is not copied so changes to it will be reflected in this instance and vice-versa.
   */
  public CardTransaction setDebitRefund(com.clover.sdk.v3.payments.DebitRefund debitRefund) {
    return genClient.setRecord(debitRefund, CacheKey.debitRefund);
  }
  ...
  /** Clears the 'debitRefund' field, the 'has' method for this field will now return false */
  public void clearDebitRefund() {
    genClient.clear(CacheKey.debitRefund);
  }
  ...
  public interface Constraints {
    ...
    public static final boolean DEBITREFUND_IS_REQUIRED = false;
  }
