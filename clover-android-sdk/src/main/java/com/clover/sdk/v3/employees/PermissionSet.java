...
public final class PermissionSet implements android.os.Parcelable, com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  */
  ...
  private com.clover.sdk.v3.employees.Permissions extractPermissions() {
    ...
    if (jsonObj != null) {
      return new com.clover.sdk.v3.employees.Permissions(getJSONObject().optJSONObject("permissions"));
    }
    return null;
  }
  ...
  public void mergeChanges(PermissionSet src) {
    if (src.changeLog != null) {
      try {
        ...
        org.json.JSONObject srcObj = new PermissionSet(src).getJSONObject();
