...
public enum TxFormat implements Parcelable {
  ...
  public static final Creator<TxFormat> CREATOR = new Creator<TxFormat>() {
    @Override
    public TxFormat createFromParcel(final Parcel source) {
      return TxFormat.valueOf(source.readString());
    }

    @Override
    public TxFormat[] newArray(final int size) {
