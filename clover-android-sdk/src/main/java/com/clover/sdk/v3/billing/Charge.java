 ...
 * <li>{@link #getStmtMonth stmtMonth}</li>
 * <li>{@link #getExportMonth exportMonth}</li>
 * <li>{@link #getCreatedTime createdTime}</li>
 * <li>{@link #getModifiedTime modifiedTime}</li>
 * <li>{@link #getStatusModifiedTime statusModifiedTime}</li>
 ...
 * <li>{@link #getPartialCharge partialCharge}</li>
 * <li>{@link #getAdditionalFeeDetails additionalFeeDetails}</li>
 * </ul>
 */
...
public class Charge extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
   ...
   */
  public java.util.List<com.clover.sdk.v3.billing.PartialCharge> getPartialCharge() {
   ...
   */
  public java.util.List<com.clover.sdk.v3.billing.AdditionalFeeDetails> getAdditionalFeeDetails() {
  ...
  /**
   * Sets the field 'partialCharge'.
   *
   * Nulls in the given List are skipped. List parameter is copied, so it will not reflect any changes, but objects inside it will.
   */
  public Charge setPartialCharge(java.util.List<com.clover.sdk.v3.billing.PartialCharge> partialCharge) {
   ...
   * Nulls in the given List are skipped. List parameter is copied, so it will not reflect any changes, but objects inside it will.
   */
  public Charge setAdditionalFeeDetails(java.util.List<com.clover.sdk.v3.billing.AdditionalFeeDetails> additionalFeeDetails) {
