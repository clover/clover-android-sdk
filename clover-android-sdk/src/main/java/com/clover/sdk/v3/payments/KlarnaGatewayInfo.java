...
public class KlarnaGatewayInfo extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private final GenericClient<KlarnaGatewayInfo> genClient;

  /**
   * Constructs a new empty instance.
   */
  public KlarnaGatewayInfo() {
    genClient = new GenericClient<KlarnaGatewayInfo>(this);
  }
  ...
  public static final android.os.Parcelable.Creator<KlarnaGatewayInfo> CREATOR = new android.os.Parcelable.Creator<KlarnaGatewayInfo>() {
    @Override
  ...
  public static final com.clover.sdk.JSONifiable.Creator<KlarnaGatewayInfo> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<KlarnaGatewayInfo>() {
    public Class<KlarnaGatewayInfo> getCreatedClass() {
