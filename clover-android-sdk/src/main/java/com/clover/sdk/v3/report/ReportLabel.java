...
public class ReportLabel extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  /**
   * Items with showInReporting=true shall appear in the Labels Summary sections.
   */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<ReportLabel> {
    id {
      @Override
      public Object extractValue(ReportLabel instance) {
  ...
  private GenericClient<ReportLabel> genClient;

  /**
   * Constructs a new empty instance.
   */
  public ReportLabel() {
    genClient = new GenericClient<ReportLabel>(this);
  }
   ...
   * Constructs a new empty instance.
   */
  protected ReportLabel(boolean noInit) {
    genClient = null;
  }
   ...
   */
  public ReportLabel(org.json.JSONObject jsonObject) {
    this();
   ...
   */
  public ReportLabel(ReportLabel src) {
    this();
   ...
   * Sets the field 'id'.
   */
  public ReportLabel setId(java.lang.String id) {
   ...
   * Sets the field 'name'.
   */
  public ReportLabel setName(java.lang.String name) {
   ...
   */
  public ReportLabel setShowInReporting(java.lang.Boolean showInReporting) {
   ...
   */
  public ReportLabel copyChanges() {
    ReportLabel copy = new ReportLabel();
   ...
   */
  public void mergeChanges(ReportLabel src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new ReportLabel(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<ReportLabel> CREATOR = new android.os.Parcelable.Creator<ReportLabel>() {
    @Override
    public ReportLabel createFromParcel(android.os.Parcel in) {
      ReportLabel instance = new ReportLabel(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public ReportLabel[] newArray(int size) {
      return new ReportLabel[size];
    }
  };
