...
public class CashAdjustmentsDeviceGroups extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
   ...
   */
  public java.util.List<com.clover.sdk.v3.report.CashAdjustmentsByDevice> getRows() {
  ...
  private final GenericClient<CashAdjustmentsDeviceGroups> genClient;

  /**
   * Constructs a new empty instance.
   */
  public CashAdjustmentsDeviceGroups() {
    genClient = new GenericClient<CashAdjustmentsDeviceGroups>(this);
  }
   ...
   */
  public CashAdjustmentsDeviceGroups setRows(java.util.List<com.clover.sdk.v3.report.CashAdjustmentsByDevice> rows) {
  ...
  public static final android.os.Parcelable.Creator<CashAdjustmentsDeviceGroups> CREATOR = new android.os.Parcelable.Creator<CashAdjustmentsDeviceGroups>() {
    @Override
  ...
  public static final com.clover.sdk.JSONifiable.Creator<CashAdjustmentsDeviceGroups> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<CashAdjustmentsDeviceGroups>() {
    public Class<CashAdjustmentsDeviceGroups> getCreatedClass() {
