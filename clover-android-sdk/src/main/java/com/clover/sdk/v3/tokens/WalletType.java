 ...
 * type of the wallet - Apple or Google pay
 */
...
public enum WalletType implements Parcelable {
  ...
  public static final Creator<WalletType> CREATOR = new Creator<WalletType>() {
    @Override
    public WalletType createFromParcel(final Parcel source) {
      return WalletType.valueOf(source.readString());
    }

    @Override
    public WalletType[] newArray(final int size) {
