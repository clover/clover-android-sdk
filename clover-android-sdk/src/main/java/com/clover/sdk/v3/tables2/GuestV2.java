 ...
 * <li>{@link #getGuestInfo guestInfo}</li>
 * </ul>
 */
@SuppressWarnings("all")
public class GuestV2 extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  /**
   * Reference to the Table Order the guest belongs to
   */
  public com.clover.sdk.v3.base.Reference getTableOrder() {
  ...
  /**
   * Guest level info that cover different use cases like allergens, etc.
   */
  public com.clover.sdk.v3.order.GuestInfo getGuestInfo() {
    return genClient.cacheGet(CacheKey.guestInfo);
  }
  ...
  private enum CacheKey implements com.clover.sdk.ExtractionStrategyEnum {
    ...
    deletedTime
        (com.clover.sdk.extractors.BasicExtractionStrategy.instance(java.lang.Long.class)),
    guestInfo
        (com.clover.sdk.extractors.RecordExtractionStrategy.instance(com.clover.sdk.v3.order.GuestInfo.JSON_CREATOR)),
    ;
  ...
  private final GenericClient<GuestV2> genClient;

  /**
   * Constructs a new empty instance.
   */
  public GuestV2() {
    genClient = new GenericClient<GuestV2>(this);
  }
   ...
   * Constructs a new empty instance.
   */
  protected GuestV2(boolean noInit) {
    genClient = null;
  }
   ...
   */
  public GuestV2(org.json.JSONObject jsonObject) {
    this();
  ...
  /** Checks whether the 'guestInfo' field is set and is not null */
  public boolean isNotNullGuestInfo() {
    return genClient.cacheValueIsNotNull(CacheKey.guestInfo);
  }
  ...
  /** Checks whether the 'guestInfo' field has been set, however the value could be null */
  public boolean hasGuestInfo() {
    return genClient.cacheHasKey(CacheKey.guestInfo);
  }
   ...
   * Sets the field 'id'.
   */
  public GuestV2 setId(java.lang.String id) {
   ...
   */
  public GuestV2 setNumber(java.lang.Integer number) {
   ...
   */
  public GuestV2 setTableOrder(com.clover.sdk.v3.base.Reference tableOrder) {
   ...
   * The parameter is not copied so changes to it will be reflected in this instance and vice-versa.
   */
  public GuestV2 setMerchant(com.clover.sdk.v3.merchant.Merchant merchant) {
   ...
   * Sets the field 'name'.
   */
  public GuestV2 setName(java.lang.String name) {
   ...
   * The parameter is not copied so changes to it will be reflected in this instance and vice-versa.
   */
  public GuestV2 setTable(com.clover.sdk.v3.tables2.Table table) {
   ...
   * The parameter is not copied so changes to it will be reflected in this instance and vice-versa.
   */
  public GuestV2 setOrder(com.clover.sdk.v3.order.Order order) {
   ...
   */
  public GuestV2 setCreatedTime(java.lang.Long createdTime) {
   ...
   */
  public GuestV2 setModifiedTime(java.lang.Long modifiedTime) {
   ...
   */
  public GuestV2 setDeletedTime(java.lang.Long deletedTime) {
    return genClient.setOther(deletedTime, CacheKey.deletedTime);
  }

  /**
   * Sets the field 'guestInfo'.
   *
   * The parameter is not copied so changes to it will be reflected in this instance and vice-versa.
   */
  public GuestV2 setGuestInfo(com.clover.sdk.v3.order.GuestInfo guestInfo) {
    return genClient.setRecord(guestInfo, CacheKey.guestInfo);
  }
  ...
  /** Clears the 'guestInfo' field, the 'has' method for this field will now return false */
  public void clearGuestInfo() {
    genClient.clear(CacheKey.guestInfo);
  }
   ...
   */
  public GuestV2 copyChanges() {
    GuestV2 copy = new GuestV2();
   ...
   */
  public void mergeChanges(GuestV2 src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new GuestV2(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<GuestV2> CREATOR = new android.os.Parcelable.Creator<GuestV2>() {
    @Override
    public GuestV2 createFromParcel(android.os.Parcel in) {
      GuestV2 instance = new GuestV2(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public GuestV2[] newArray(int size) {
      return new GuestV2[size];
    }
  };
  ...
  public interface Constraints {
    ...
    public static final boolean GUESTINFO_IS_REQUIRED = false;
  }
