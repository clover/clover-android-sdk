...
public enum AdditionalChargeType implements Parcelable {
  INTERAC, CREDIT_SURCHARGE, CONVENIENCE_FEE, INTERAC_V2, DELIVERY_FEE, CASH_DISCOUNT, VISA_CREDIT, VISA_DEBIT, VISA_INTERNATIONAL, MASTERCARD_CREDIT, MASTERCARD_DEBIT, MASTERCARD_INTERNATIONAL, AMEX, EFTPOS, JCB, CUP_CREDIT, CUP_DEBIT, DINERS_CLUB, ROUNDING;
