...
public class GuestLineItem extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
   ...
   */
  public com.clover.sdk.v3.tables2.Guest getGuest() {
    return genClient.cacheGet(CacheKey.guest);
  }
   ...
   */
  public GuestLineItem(org.json.JSONObject jsonObject) {
    this();
  ...
  public boolean isNotNullGuest() {
    return genClient.cacheValueIsNotNull(CacheKey.guest);
  }
  ...
  public boolean hasGuest() {
    return genClient.cacheHasKey(CacheKey.guest);
  }
   ...
   * Sets the field 'id'.
   */
  public GuestLineItem setId(java.lang.String id) {
   ...
   */
  public GuestLineItem setLineItem(com.clover.sdk.v3.order.LineItem lineItem) {
   ...
   * The parameter is not copied so changes to it will be reflected in this instance and vice-versa.
   */
  public GuestLineItem setGuest(com.clover.sdk.v3.tables2.Guest guest) {
    return genClient.setRecord(guest, CacheKey.guest);
  }
   ...
   * The parameter is not copied so changes to it will be reflected in this instance and vice-versa.
   */
  public GuestLineItem setMerchant(com.clover.sdk.v3.merchant.Merchant merchant) {
   ...
   */
  public GuestLineItem setCreatedTime(java.lang.Long createdTime) {
   ...
   */
  public GuestLineItem setModifiedTime(java.lang.Long modifiedTime) {
   ...
   */
  public GuestLineItem setDeletedTime(java.lang.Long deletedTime) {
  ...
  public void clearGuest() {
    genClient.clear(CacheKey.guest);
  }
  ...
  public GuestLineItem copyChanges() {
    GuestLineItem copy = new GuestLineItem();
  ...
  public void mergeChanges(GuestLineItem src) {
    if (src.genClient.getChangeLog() != null) {
      genClient.mergeChanges(new GuestLineItem(src).getJSONObject(), src.genClient);
    }
  }

  public static final android.os.Parcelable.Creator<GuestLineItem> CREATOR = new android.os.Parcelable.Creator<GuestLineItem>() {
    @Override
    public GuestLineItem createFromParcel(android.os.Parcel in) {
      GuestLineItem instance = new GuestLineItem(com.clover.sdk.v3.JsonParcelHelper.ObjectWrapper.CREATOR.createFromParcel(in).unwrap());
    ...
    @Override
    public GuestLineItem[] newArray(int size) {
      return new GuestLineItem[size];
    }
  };

  public static final com.clover.sdk.JSONifiable.Creator<GuestLineItem> JSON_CREATOR = new com.clover.sdk.JSONifiable.Creator<GuestLineItem>() {
    @Override
    public GuestLineItem create(org.json.JSONObject jsonObject) {
