...
public class Payment extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  /**
   * Collection of used features during a transaction (e.g. Accessibility Mode)
   */
  ...
  /**
   * The discount which is associated with this payment
   */
  public com.clover.sdk.v3.order.Discount getDiscount() {
  ...
  private enum CacheKey implements com.clover.sdk.ExtractionStrategyEnum {
    ...
    capture
        (com.clover.sdk.extractors.BasicExtractionStrategy.instance(java.lang.Boolean.class)),
    discount
        (com.clover.sdk.extractors.RecordExtractionStrategy.instance(com.clover.sdk.v3.order.Discount.JSON_CREATOR)),
    ;
   ...
   * The parameter is not copied so changes to it will be reflected in this instance and vice-versa.
   */
  public Payment setDiscount(com.clover.sdk.v3.order.Discount discount) {
