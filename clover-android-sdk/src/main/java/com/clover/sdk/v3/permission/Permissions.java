...
public final class Permissions implements android.os.Parcelable, com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
   ...
   */
  public java.util.List<com.clover.sdk.v3.permission.Permission> getReadablePermissions() {
    return cacheGet(CacheKey.readablePermissions);
  }

  private java.util.List<com.clover.sdk.v3.permission.Permission> extractReadablePermissions() {
    ...
    java.util.List<com.clover.sdk.v3.permission.Permission> itemList =
        new java.util.ArrayList<com.clover.sdk.v3.permission.Permission>(itemArray.length());
    for (int i = 0; i < itemArray.length(); i++) {
      String enumString = itemArray.optString(i, null);
      if (enumString == null) {
        continue;
      }
      com.clover.sdk.v3.permission.Permission item;
      try {
        item = com.clover.sdk.v3.permission.Permission.valueOf(enumString);
      } catch (Exception e) {
        e.printStackTrace();
        continue;
      }
   ...
   */
  public Permissions setReadablePermissions(java.util.List<com.clover.sdk.v3.permission.Permission> readablePermissions) {
    ...
    try {
      ...
      for (com.clover.sdk.v3.permission.Permission obj : readablePermissions) {
        if (obj == null) {
          continue;
        }
        array.put(obj);
  ...
  public static final android.os.Parcelable.Creator<Permissions> CREATOR = new android.os.Parcelable.Creator<Permissions>() {
    ...
    public Permissions createFromParcel(android.os.Parcel in) {
      ...
      Permissions instance = new Permissions(json);
