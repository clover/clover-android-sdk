...
public class LimitedDevice extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<LimitedDevice> {
    id {
      @Override
      public Object extractValue(LimitedDevice instance) {
  ...
  private GenericClient<LimitedDevice> genClient;
