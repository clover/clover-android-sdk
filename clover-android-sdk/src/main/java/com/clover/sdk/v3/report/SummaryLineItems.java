...
public class SummaryLineItems extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<SummaryLineItems> {
    refundsTotal {
      @Override
      public Object extractValue(SummaryLineItems instance) {
        return instance.genClient.extractOther("refundsTotal", java.lang.Long.class);
      }
    },
    discountsTotal {
      @Override
      public Object extractValue(SummaryLineItems instance) {
        return instance.genClient.extractOther("discountsTotal", java.lang.Long.class);
      }
    },
    voidedLineItemsTotal {
      @Override
      public Object extractValue(SummaryLineItems instance) {
        return instance.genClient.extractOther("voidedLineItemsTotal", java.lang.Long.class);
      }
    },
    netItemSales {
      @Override
