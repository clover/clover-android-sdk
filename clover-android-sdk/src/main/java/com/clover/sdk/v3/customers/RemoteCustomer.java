 ...
 * <p>
 * @deprecated  Use CustomerInfo instead. /n Represents a customer that is linked to an external system.  This customer may be persisted in Clover, or it may not.
 * <p>
 * <h3>Fields</h3>
 * <ul>
...
public class RemoteCustomer extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<RemoteCustomer> {
    customer {
      @Override
      public Object extractValue(RemoteCustomer instance) {
  ...
  private GenericClient<RemoteCustomer> genClient;
