...
public class CreditRefundResponse extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<CreditRefundResponse> {
    requestSuccessful {
      @Override
      public Object extractValue(CreditRefundResponse instance) {
  ...
  private GenericClient<CreditRefundResponse> genClient;
