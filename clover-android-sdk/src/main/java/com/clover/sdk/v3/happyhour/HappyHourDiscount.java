...
public class HappyHourDiscount extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  /**
   * Discount amount in fractional percentage times 10000, e.g. 12.5% will be 125000
   */
  @Nullable
   ...
   * Sets the field 'id'.
   */
  public HappyHourDiscount setId(@Nullable java.lang.String id) {
   ...
   * Sets the field 'name'.
   */
  public HappyHourDiscount setName(@Nullable java.lang.String name) {
   ...
   */
  public HappyHourDiscount setAmount(@Nullable java.lang.Long amount) {
   ...
   */
  public HappyHourDiscount setPercentage(@Nullable java.lang.Long percentage) {
   ...
   */
  public HappyHourDiscount setPercentageDecimal(@Nullable java.lang.Long percentageDecimal) {
   ...
   */
  public HappyHourDiscount setBeginTimeHours(@Nullable java.lang.Integer beginTimeHours) {
   ...
   */
  public HappyHourDiscount setEndTimeHours(@Nullable java.lang.Integer endTimeHours) {
   ...
   */
  public HappyHourDiscount setBeginTimeMinutes(@Nullable java.lang.Integer beginTimeMinutes) {
   ...
   */
  public HappyHourDiscount setEndTimeMinutes(@Nullable java.lang.Integer endTimeMinutes) {
   ...
   */
  public HappyHourDiscount setCategoryIds(@Nullable java.util.List<java.lang.String> categoryIds) {
   ...
   * Nulls in the given List are skipped. List parameter is copied, so it will not reflect any changes, but objects inside it will.
   */
  public HappyHourDiscount setItemIds(@Nullable java.util.List<java.lang.String> itemIds) {
   ...
   * Nulls in the given List are skipped. List parameter is copied, so it will not reflect any changes, but objects inside it will.
   */
  public HappyHourDiscount setDaysOfWeek(@Nullable java.util.List<java.lang.String> daysOfWeek) {
