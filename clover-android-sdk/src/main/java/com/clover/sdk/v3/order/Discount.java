 ...
 * <li>{@link #getDiscType discType}</li>
 * </ul>
 * <p>
...
public class Discount extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  public com.clover.sdk.v3.order.DiscType getDiscType() {
    return genClient.cacheGet(CacheKey.discType);
  }
  ...
  private enum CacheKey implements com.clover.sdk.ExtractionStrategyEnum {
    ...
    percentageDecimal
        (com.clover.sdk.extractors.BasicExtractionStrategy.instance(java.lang.Long.class)),
    discType
        (com.clover.sdk.extractors.EnumExtractionStrategy.instance(com.clover.sdk.v3.order.DiscType.class)),
    ;
  ...
  /** Checks whether the 'discType' field is set and is not null */
  public boolean isNotNullDiscType() {
    return genClient.cacheValueIsNotNull(CacheKey.discType);
  }
  ...
  /** Checks whether the 'discType' field has been set, however the value could be null */
  public boolean hasDiscType() {
    return genClient.cacheHasKey(CacheKey.discType);
  }
   ...
   */
  public Discount setPercentageDecimal(java.lang.Long percentageDecimal) {
    return genClient.setOther(percentageDecimal, CacheKey.percentageDecimal);
  }

  /**
   * Sets the field 'discType'.
   */
  public Discount setDiscType(com.clover.sdk.v3.order.DiscType discType) {
    return genClient.setOther(discType, CacheKey.discType);
  }
  ...
  /** Clears the 'discType' field, the 'has' method for this field will now return false */
  public void clearDiscType() {
    genClient.clear(CacheKey.discType);
  }
  ...
  public interface Constraints {
    ...
    public static final boolean DISCTYPE_IS_REQUIRED = false;
  }
