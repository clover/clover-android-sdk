  ...
  */
  ...
  private enum CacheKey {
    ...
    discount {
      @Override
      public Object extractValue(Discount instance) {
        return instance.extractDiscount();
      }
    },
    name {
      @Override
  ...
  private com.clover.sdk.v3.base.Reference extractDiscount() {
    ...
    if (jsonObj != null) {
      return new com.clover.sdk.v3.base.Reference(getJSONObject().optJSONObject("discount"));
    }
    return null;
  }
  ...
  public boolean isNotNullDiscount() {
    return cacheValueIsNotNull(CacheKey.discount);
  }
  ...
  public boolean hasDiscount() {
    return cacheHasKey(CacheKey.discount);
  }
  ...
  public Discount setDiscount(com.clover.sdk.v3.base.Reference discount) {
    ...
    try {
      getJSONObject().put("discount",
          discount == null ? org.json.JSONObject.NULL : discount.getJSONObject());
    } catch (org.json.JSONException e) {
      throw new java.lang.IllegalArgumentException(e);
    }

    cacheMarkDirty(CacheKey.discount);
    return this;
  }
  ...
  public void clearDiscount() {
    unlogChange("discount");
    getJSONObject().remove("discount");
    cacheRemoveValue(CacheKey.discount);
  }
