...
public class LineItem extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<LineItem> {
    ...
    priceWithModifiers {
      @Override
      public Object extractValue(LineItem instance) {
        return instance.genClient.extractOther("priceWithModifiers", java.lang.Long.class);
      }
    },
    priceWithModifiersAndItemAndOrderDiscounts {
      @Override
      public Object extractValue(LineItem instance) {
        return instance.genClient.extractOther("priceWithModifiersAndItemAndOrderDiscounts", java.lang.Long.class);
      }
    },
    unitQty {
      @Override
    ...
    orderLevelDiscounts {
      @Override
      public Object extractValue(LineItem instance) {
        return instance.genClient.extractListRecord("orderLevelDiscounts", com.clover.sdk.v3.order.Discount.JSON_CREATOR);
      }
    },
    discountAmount {
      @Override
    ...
    orderLevelDiscountAmount {
      @Override
      public Object extractValue(LineItem instance) {
        return instance.genClient.extractOther("orderLevelDiscountAmount", java.lang.Long.class);
      }
    },
    exchanged {
      @Override
    ...
    quantitySold {
      @Override
      public Object extractValue(LineItem instance) {
        return instance.genClient.extractOther("quantitySold", java.lang.Double.class);
      }
    },
      ;
  }
