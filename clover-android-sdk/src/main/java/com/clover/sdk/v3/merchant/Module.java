...
public final class Module implements android.os.Parcelable, com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  */
  ...
  private enum CacheKey {
    ...
    public abstract Object extractValue(Module instance);
  }
   ...
   */
  public Module(String json) throws java.lang.IllegalArgumentException {
    try {
  ...
  public void mergeChanges(Module src) {
    if (src.changeLog != null) {
      try {
        ...
        org.json.JSONObject srcObj = new Module(src).getJSONObject();
