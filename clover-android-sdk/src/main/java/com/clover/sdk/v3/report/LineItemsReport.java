...
public class LineItemsReport extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<LineItemsReport> {
    revenueItems {
      @Override
      public Object extractValue(LineItemsReport instance) {
        return instance.genClient.extractRecord("revenueItems", com.clover.sdk.v3.report.LineItemsArrayAndWarning.JSON_CREATOR);
      }
    },
    nonRevenueItems {
      @Override
      public Object extractValue(LineItemsReport instance) {
        return instance.genClient.extractRecord("nonRevenueItems", com.clover.sdk.v3.report.LineItemsArrayAndWarning.JSON_CREATOR);
      }
    },
    majorLabelsExist {
      @Override
      public Object extractValue(LineItemsReport instance) {
        return instance.genClient.extractOther("majorLabelsExist", java.lang.Boolean.class);
      }
    },
      ;
  }

  private GenericClient<LineItemsReport> genClient;
