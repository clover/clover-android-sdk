 ...
 * <li>{@link #getServiceFeePaymentId serviceFeePaymentId}</li>
 * <li>{@link #getServiceFeeOrderId serviceFeeOrderId}</li>
...
public class PaymentRequest extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  public java.lang.Boolean getSinglePayToken() {
    return genClient.cacheGet(CacheKey.singlePayToken);
  }
  ...
  public boolean isNotNullSinglePayToken() {
    return genClient.cacheValueIsNotNull(CacheKey.singlePayToken);
  }
  ...
  public boolean hasSinglePayToken() {
    return genClient.cacheHasKey(CacheKey.singlePayToken);
  }
   ...
   */
  public PaymentRequest setSinglePayToken(java.lang.Boolean singlePayToken) {
    return genClient.setOther(singlePayToken, CacheKey.singlePayToken);
  }
  ...
  public void clearSinglePayToken() {
    genClient.clear(CacheKey.singlePayToken);
  }
