...
public final class AppMeteredEvent implements android.os.Parcelable, com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  public void validate() {
    ...
    java.lang.Long count = getCount();
    if (count == null) throw new java.lang.IllegalArgumentException("'count' is required to be non-null");
  }
  ...
  private com.clover.sdk.v3.apps.AppMetered extractAppMetered() {
    ...
    if (jsonObj != null) {
      return new com.clover.sdk.v3.apps.AppMetered(getJSONObject().optJSONObject("appMetered"));
    }
    return null;
  }
  ...
  public void mergeChanges(AppMeteredEvent src) {
    if (src.changeLog != null) {
      try {
        ...
        org.json.JSONObject srcObj = new AppMeteredEvent(src).getJSONObject();
