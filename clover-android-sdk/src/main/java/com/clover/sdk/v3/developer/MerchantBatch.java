...
public class MerchantBatch extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<MerchantBatch> {
    merchants {
      @Override
      public Object extractValue(MerchantBatch instance) {
        return instance.genClient.extractListRecord("merchants", com.clover.sdk.v3.base.Reference.JSON_CREATOR);
      }
    },
      ;
  }

  private GenericClient<MerchantBatch> genClient;
