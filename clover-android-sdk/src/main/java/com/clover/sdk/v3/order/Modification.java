...
public class Modification extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ExtractionStrategyEnum {
    ...
    modifier
        (com.clover.sdk.extractors.RecordExtractionStrategy.instance(com.clover.sdk.v3.inventory.Modifier.JSON_CREATOR)),
    quantitySold
        (com.clover.sdk.extractors.BasicExtractionStrategy.instance(java.lang.Long.class)),
      ;
  ...
  private final GenericClient<Modification> genClient;

  /**
   * Constructs a new empty instance.
   */
  public Modification() {
    genClient = new GenericClient<Modification>(this);
  }
