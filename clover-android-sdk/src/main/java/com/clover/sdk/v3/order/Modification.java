  ...
  */
  ...
  private enum CacheKey {
    ...
    modifier {
      @Override
      public Object extractValue(Modification instance) {
        return instance.extractModifier();
      }
    },
    ;
  ...
  private com.clover.sdk.v3.inventory.Modifier extractModifier() {
    ...
    if (jsonObj != null) {
      return new com.clover.sdk.v3.inventory.Modifier(getJSONObject().optJSONObject("modifier"));
    }
    return null;
  }
  ...
  public boolean isNotNullModifier() {
    return cacheValueIsNotNull(CacheKey.modifier);
  }
  ...
  public boolean hasModifier() {
    return cacheHasKey(CacheKey.modifier);
  }
  ...
  public Modification setModifier(com.clover.sdk.v3.inventory.Modifier modifier) {
    ...
    try {
      getJSONObject().put("modifier",
          modifier == null ? org.json.JSONObject.NULL : modifier.getJSONObject());
    } catch (org.json.JSONException e) {
      throw new java.lang.IllegalArgumentException(e);
    }

    cacheMarkDirty(CacheKey.modifier);
    return this;
  }
  ...
  public void clearModifier() {
    unlogChange("modifier");
    getJSONObject().remove("modifier");
    cacheRemoveValue(CacheKey.modifier);
  }
  ...
  public void mergeChanges(Modification src) {
    if (src.changeLog != null) {
      try {
        ...
        org.json.JSONObject srcObj = new Modification(src).getJSONObject();
