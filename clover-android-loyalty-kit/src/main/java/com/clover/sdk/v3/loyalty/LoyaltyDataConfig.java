...
public class LoyaltyDataConfig extends GenericParcelable implements com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<LoyaltyDataConfig> {
    type {
      @Override
      public Object extractValue(LoyaltyDataConfig instance) {
    ...
    configuration {
      @Override
      public Object extractValue(LoyaltyDataConfig instance) {
        return instance.genClient.extractMap("configuration");
      }
    },
      ;
  }
